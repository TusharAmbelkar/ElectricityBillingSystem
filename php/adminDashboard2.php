...
<body>
	...
	<div style="width: 100%">
		...
		<div style="width: 20%; float: left;border: 2px solid black; border-radius: 8px;height: 100%;padding: 5px;margin: 2px;" class="center-block">
			...
			<br>
			<a href="adminDashboard2.php" style="width:90%;margin: auto;"><button class="btn btn-primary center-block active" style="width: 80%">Acknowledge discontinuation<br> request</button></a>
			<br>
